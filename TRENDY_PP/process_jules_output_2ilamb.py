...
varListDefault = ["gpp", "npp", "evapotrans", "cveg", "lai"]
...
def get_test_inputs():
    ...
    """
    filesIn = "../DATA/JULES-ES.1p0.vn5.1.500.CRUJRA1.365.S3.Monthly.*.nc"
    procDir = "../PROC"
    outDir = "../MODEL_DATA"
    outName = "JULES-ES.1p0.vn5.1.500.CRUJRA1.365.S3.Monthly.2D"
    monStart  = 1     # =None: use all times
    yearStart = 2000  # =None: use all times
    monEnd    = 12    # =None: use all times
    yearEnd   = 2017  # =None: use all times
    varListIn=None #varListIn = ["sw_net"] # =None: use varListDefault
